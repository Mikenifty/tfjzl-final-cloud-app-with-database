...
# Implement a submit view to create an exam submission record for a course enrollment based on following logic:
...
# Implement an exam result view based on the following logic:
